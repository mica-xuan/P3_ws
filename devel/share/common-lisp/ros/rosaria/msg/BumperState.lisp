...
(cl:defclass <BumperState> (roslisp-msg-protocol:ros-message)
  ((header
    ...
    :initform (cl:make-i; Auto-generated. Do not edit!
...
(cl:defmethod cl:initialize-instance :after ((m <BumperState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BumperState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosaria-msg:<BumperState> is deprecated: use rosaria-msg:BumperState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <BumperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosaria-msg:header-val is deprecated.  Use rosaria-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'front_bumpers-val :lambda-list '(m))
(cl:defmethod front_bumpers-val ((m <BumperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosaria-msg:front_bumpers-val is deprecated.  Use rosaria-msg:front_bumpers instead.")
  (front_bumpers m))

(cl:ensure-generic-function 'rear_bumpers-val :lambda-list '(m))
(cl:defmethod rear_bumpers-val ((m <BumperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosaria-msg:rear_bumpers-val is deprecated.  Use rosaria-msg:rear_bumpers instead.")
  (rear_bumpers m))
