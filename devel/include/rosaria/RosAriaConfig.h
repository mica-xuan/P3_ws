...
namespace rosaria
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(RosAriaConfig &config, const RosAriaConfig &max, const RosAriaConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const RosAriaConfig &config1, const RosAriaConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, RosAriaConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const RosAriaConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, RosAriaConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const RosAriaConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const RosAriaConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, RosAriaConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
